      ...
      <div className="auth-wrapper">
        <div className="auth-brand">
            ...
            <div className="auth-quote">
              <div className="auth-badge">Coach IA · 4 Langues</div>
          ...
          <div className="auth-panel">
            ...
            {isLogin ? (
              <form className="auth-form" onSubmit={handleLogin}>
                <div className="field">
                  <label>Email</label>
                  <input type="email" name="login-email" placeholder="coach@fitbot.com" required />
                </div>
                <div className="field">
                  <label>Password</label>
                  <input type="password" name="login-pass" placeholder="••••••••" required />
                </div>
              ...
              <form className="auth-form" onSubmit={handleRegister}>
                <div className="field-row">
                  <div className="field">
                    ...
                    <input type="text" name="reg-first" placeholder="John" />
                  </div>
                  <div className="field">
                    <label>Last Name</label>
                    <input type="text" name="reg-last" placeholder="Doe" />
                  </div>
                </div>
                <div className="field">
                  <label>Email</label>
                  <input type="email" name="reg-email" placeholder="yourname@gmail.com" required />
                </div>
                <div className="field">
                  <label>Password</label>
                  <input type="password" name="reg-pass" placeholder="Min 6 characters" minLength="6" required />
                </div>
                <div className="field">
                  <label>Confirm Password</label>
                  <input type="password" name="reg-pass2" placeholder="••••••••" required />
                </div>
                {error && <div className="form-error">{error}</div>}
                <button type="submit" className="btn-primary" disabled={loading}>
